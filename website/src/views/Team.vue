    ...
    <v-container v-if="team">
      <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-12">
          <v-row align="center">
            <ImageDialog :show.sync="showImageDialog" :url="team.image"></ImageDialog>
            <img style="width: 100%" :src="team.image" alt="preview" @click="showImageDialog = true"/>
          </v-row>
...
<script>
  import ImageDialog from "@/components/_partial/ImageDialog";
  import {ProcessStr, DateConversion, RedirectToCloudFront} from "../assets/utils"
      ...
      getTeamDetail(id) {
        ...
        getTeamByID(id).then(res => {
          if (res.data.code === SUCCESS) {
            ...
            // CDN acceleration
            this.team.image = RedirectToCloudFront(this.team.image)
          } else {
